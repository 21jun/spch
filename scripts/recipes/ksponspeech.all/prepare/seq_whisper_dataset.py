...
class KsponSpeechSeq2SeqDataset(AbstractAudioDataset):
...
def prepare(cfg, processor):
    ...
    eval_datasets = {
        "ksponspeech-dev-clean": [],
        "ksponspeech-test-clean": [],
    }
    ...
    eval_datasets["ksponspeech-dev-clean"] = KsponSpeechSeq2SeqDataset(
    ...
    eval_datasets["ksponspeech-test-clean"] = KsponSpeechSeq2SeqDataset(
    ...
    test_clean_dataloader = DataLoader(
        eval_datasets["ksponspeech-dev-clean"],
        shuffle=False,
        collate_fn=collate_fn,
    ...
    dev_clean_dataloader = DataLoader(
        eval_datasets["ksponspeech-test-clean"],
        shuffle=False,
        collate_fn=collate_fn,
        batch_size=cfg.train.per_device_eval_batch_size,
        drop_last=False,
    ...
    eval_dataloaders = {
        "ksponspeech-dev-clean": test_clean_dataloader,
        "ksponspeech-test-clean": dev_clean_dataloader,
    }
